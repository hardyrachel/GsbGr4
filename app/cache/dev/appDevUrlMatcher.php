...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Gsb')) {
            ...
            // ad_gsp_entreprise
            if ($pathinfo === '/Gsb/entreprise') {
                return array (  '_controller' => 'AD\\GsbBundle\\Controller\\presentationController::entrepriseAction',  '_route' => 'ad_gsp_entreprise',);
            }

            // ad_gsp_activite
            if ($pathinfo === '/Gsb/activite') {
                return array (  '_controller' => 'AD\\GsbBundle\\Controller\\presentationController::activiteAction',  '_route' => 'ad_gsp_activite',);
            }

            // ad_gsb_description
            if (rtrim($pathinfo, '/') === '/Gsb') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'ad_gsb_description');
                }

                return array (  '_controller' => 'AD\\GsbBundle\\Controller\\siController::descriptionAction',  '_route' => 'ad_gsb_description',);
            }
